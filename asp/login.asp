        ...
        <div align="center" class="stil6">
          ...
          <form name="form1" method="post" action="login2.asp">
            ...
            <input name="password" class="n1" type="password" id="password" maxlength="36">
             ...
             <input type="submit" class="buton" name="send" id="send" value="giriş yap"> 
             
<input type="button" class="buton2" onClick="gizle('nesneID');" value="parolamı unuttum!">
            
           
          </form>
        <div id="nesneID" style="display:none;">
        <hr size="1" noshade="noshade" style="color:#E6E6E6;"><form>
        e-posta: <input type="text" class="n2" name="komut" id="komut" value="@"> <input type="button" onClick="komutekle()" class="but" value="gönder">
